...
Скрипт уже умеет распознавать руку и показывать название жеста в реальном времени, но пока еще не:

- подбирает мем по жесту;
- не переключает сцены или источники в OBS;
- не анализирует мимику лица;
- не читает теги из библиотеки мемов.
...
- закрытие окна мышкой - тоже останавливает цикл
